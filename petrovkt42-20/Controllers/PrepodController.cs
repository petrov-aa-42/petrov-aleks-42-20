...
namespace petrovkt42_20.Controllers
{
    ...
    public class PrepodController : ControllerBase
    {
        ...
        public IActionResult CreatePrepod([FromBody] Prepod prepod)
        {
            ...
            var kaf = _context.Kafedra.FirstOrDefault(k => k.KafedraId == prepod.KafedraId);
            if (kaf != null)
            {
                prepod.Kafedra = kaf;
            }
        ...
        public IActionResult CreateKafedra([FromBody] petrovkt42_20.Models.Kafedra kafedra)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        public IActionResult DeleteKafedra(string kafedraName, petrovkt42_20.Models.Kafedra updatedKafedra)
        {
            var existingKafedra = _context.Kafedra.FirstOrDefault(g => g.KafedraName == kafedraName);
